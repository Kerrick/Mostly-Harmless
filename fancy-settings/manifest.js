...
this.manifest = {
    ...
    "settings": [
        ...
        },
        {
        	...
        	"type": "description",
        	"text": "<p>This setting allows you to choose the oldest reddit posts you&rsquo;d like to see. Anything posted before the value you&rsquo;ve chosen not be indicated in the browser button's total, but will not be shown in the popup."
        }
    ]
};
